    ...
    return (
        <section id="privacy-policy">
            <div class="privacy-policy-heading">
                ...
                <button id="close-button" onClick={props.togglePrivacy} ><i className="fa-solid fa-xmark fa-lg"></i></button>
            </div>
            <p>
                {`Melbourne Football Club is committed to providing quality services to you and this policy outlines our
                ...
                Privacy Act). The NPPs govern the way in which we collect, use, disclose, store, secure and dispose of
                your
                ...
                Information we collect includes names, addresses, email addresses, phone and facsimile numbers.
                This Personal Information is obtained in many ways including [interviews, correspondence, by telephone
                and
                facsimile, by email, via our website www.yourbusinessname.com.au, from your website, from media and
                publications, from other publicly available sources, from cookies- delete all that aren’t applicable]
                and
                ...
                Personal Information is or will be stored in client files which will be kept by us for a minimum of 7
                years.
                ...
                Melbourne Football Club will not charge any fee for your access request, but may charge an
                administrative
                ...
                make
                sure that your Personal Information is accurate, complete and up-to-date. If you find that the
                information
